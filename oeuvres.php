<?php 
  $oeuvres = [
    ...
    [ 'id'=> 4,
      'nom_oeuvre' => 'Le refuge de l\'Havre',
    ...
    [ 'id'=> 8,
    'nom_oeuvre' => 'Blast from the past',
